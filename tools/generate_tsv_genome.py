...
GENOME_IMAGE_DIR = 'data/VisualGenome/VG_100K'
GENOME_IMAGE_LIST = 'data/VisualGenome/annotations/image_data.json'

def load_image_ids():
    image_ids = json.load(open(GENOME_IMAGE_LIST, 'r'))
    images = [('{}/{}.jpg'.format(GENOME_IMAGE_DIR, image['image_id']),
               image['image_id']) for image in image_ids]
    return images

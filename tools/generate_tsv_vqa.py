...
VQA_IMAGE_DIR = 'data/VQA_v2/images'
VQA_QUESTIONS = [
...
def load_image_ids(split_name):
    ...
    image_ids = []
    images = []
    for filename in VQA_QUESTIONS:
        f = json.load(open(filename, 'r'))
        split = f['data_subtype']
        split_image_ids = list(set([q['image_id'] for q in f['questions']]))

        for image_id in split_image_ids:
            image_path = '{}/COCO_{}_{:012d}.jpg'.format(
